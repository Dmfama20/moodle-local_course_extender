...
class course_extender_form extends moodleform {
    ...
    public function definition() {
        ...
        $recordexists= $DB->get_record('local_course_extender', array('courseid' => $this->_customdata['courseid'] ));
        $a = new stdClass();
        ...
        if(!$recordexists) {
            ...
            $dbdata= $DB->get_record('local_course_extender', array('courseid' => $this->_customdata['courseid'] ));
