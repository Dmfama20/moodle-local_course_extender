...
class local_course_extender_external extends external_api {
    ...
    public static function get_information($courseids) {
        ...
        $params = self::validate_parameters(self::get_information_parameters(), array('courseids'=>$courseids));
        ...
        foreach ($params['courseids'] as $courseid) {
            ...
            if(empty($course))  {
                ...
                $courseextinformation=$DB->get_record('local_course_extender', array('courseid' => $courseid));
                $returnarray[] = array(
                    'id' => $courseid,
        ...
        return array('courses' => $returnarray);
    }
